...
######################################################################################################
#first selector
if ($file -match "TitlePage"){MakeTextObjectHTML -AlignTextBlockHTML "Title" -FontTextBlock $null -LineVPOS 0 }
Else {
...
if ((!$xmlComposedBlock)-and(!$xml.TextBlock)){
...
if (($xmlIlustration.HEIGHT -ge 250) -and ($xmlIlustration.WIDTH -ge 250)){
...
#SavePictureMAP -HEIGHT $xmlComposedBlockHEIGHT -WIDTH $xmlComposedBlock.WIDTH -VPOS $xmlComposedBlock.VPOS -HPOS $xmlComposedBlock.HPOS
