...
if ((!$xml.textblock) -and (!$xml.Illustration) -and (!$xmlComposedBlock.TextBlock)){
...
MakeTextObjectHTML -AlignTextBlockHTML "Ilustration" -FontTextBlock $null -LineVPOS $xmlComposedBlock.Illustration.VPOS

#SavePictureMAP -HEIGHT -WIDTH -VPOS -HPOS

SavePictureMAP -HEIGHT $xmlComposedBlock.Illustration.HEIGHT -WIDTH $xmlComposedBlock.Illustration.WIDTH -VPOS $xmlComposedBlock.Illustration.VPOS -HPOS $xmlComposedBlock.Illustration.HPOS
}
