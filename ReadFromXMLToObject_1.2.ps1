...
$altoLineCount = @($xml.TextBlock[$altoTextBlock].TextLine).count -1

##block Style and Font
$TextBlockStyle = $Alto.alto.Styles.ParagraphStyle | Where-Object {$xml.TextBlock[$altoTextBlock].STYLEREFS -match $_.ID}
$TextBlockFont = $Alto.alto.Styles.TextStyle | Where-Object {$xml.TextBlock[$altoTextBlock].STYLEREFS -match $_.ID}
...
$TextBlockAverage = ($xml.TextBlock[$altoTextBlock].TextLine | Measure-Object HPOS -Average).Average

# if line offset 13%
if  ($xml.TextBlock[$altoTextBlock].TextLine[$altoLine].HPOS/($TextBlockAverage/100) -ge 113 ){
...
#$counter = 0
#################################################################################################
$xml.TextBlock[$altoTextBlock].TextLine[$altoLine].String | ForEach-Object -Process {
