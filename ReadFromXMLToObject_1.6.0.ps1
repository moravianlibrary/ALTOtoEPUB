...
#$Global:Book[$Global:BookPointer].Word[$Global:BookWordpointe - 1].String
    if ((($Global:Book[$Global:BookPointer].word | Select-Object -Last 1) -ne $null) -and ($Global:Book[$Global:BookPointer].Type -eq "TextBlock") -and (($Global:Book[$Global:BookPointer].word | Select-Object -Last 1).SubPrefix -eq $StylewordPrefix  ) ){
...
Else{
    ...
    If ((($Global:Book[$Global:BookPointer].word | Select-Object -Last 1) -ne $null) -and $Global:Book[$Global:BookPointer].Type -eq "TextBlock"){
